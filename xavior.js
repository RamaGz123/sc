...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
  ...
  goblok = fs.readFileSync('./video/ga.jpg')
                xavior.sendMessage(m.chat, { image: goblok, caption: `*Halo Bre 😁*\n\n Bot Rental Prices\n⭔ 7k Per Group via GopayOvoDana Permanen\n⭔ 5k vvia OvoDanaGopay 1 Minggu\n\n\nhttps://wa.me/628985476150 (Owner)\n\nDonate For Me : \n\n⭔ Saweria : https://saweria.co/ramaajh` }, { quoted: m })
            }
            case 'subscribe':{
            smeme = fs.readFileSync('./video/bro.mp4')

xavior.sendMessage(m.chat, { video: smeme, mimetype: 'video/mp4', fileName: `subrek.mp4`, caption: `Betewe Lu Dah Janji Mau Subscribe\n\nJangan PHP Yah 😊\n\nSubscibe:https://youtube.com/channel/UCwHiMhqOxZsLvNjgM8O96Qg`},{ quoted: m })} break
...
xavior.sendMessage(m.chat, {audio: goblok, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
 xavior.sendMessage(m.chat, {document: ana, mimetype: 'application/zip', fileName: `XaviorV2.zip`}, {quoted:m})}
            ...
            ana = fs.readFileSync('./Xavior.json')
              m.reply('*Woe Bre Minimal Subscribe Yt RamaBotz Lah*')
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'Script',
                                    url: 'https://youtube.com/channel/UCwHiMhqOxZsLvNjgM8O96Qg'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+628985476150'
                                }
                            }, {
                                quickReplyButton: {
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nContoh : ${prefix + command} Subscribe Yt RamaBotz`
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            case 'okay': { m.reply('Subrek lah Yt Ramakull')} break
            
             case 'menu': {
            anu = `Hallo Bre... 🤗\nSalken Bre, Gua *RamaBotz*🤝\nGua Bot WhatsApp MD Bre..\nKalo Menu Gk Usah Spam Ya!!\nInfo Lanjut Dengerin VN nya Bre`
            let btn = [{
